    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notice_a', models.TextField(default='', max_length=220, verbose_name='Describe Answer')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title_q', models.CharField(max_length=100, verbose_name='Title of Question')),
                ('notice_q', models.TextField(default='', max_length=220, verbose_name='Description of Question')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('reported_a', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.answer')),
            ],
        ),
        migrations.AddField(
            model_name='answer',
